...
def create_retrieval_agent(llm_config, agent_name):
    ...
    return ConversableAgent(
        ...
        system_message="""You are a RetrievalAgent in Dell's technical support workflow. Your role is to fetch up to 5 relevant chunks from the vector DB for ChannelAgent, using 'VL.pdf' in the channel_agent table.
